    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 60px;"><img width="60px" height="35px" src="' + this.image + '"/></td>' +
          '<td title="Name">' + this.name + '</td>' +
          '<td title="Unit Price" class="text-center">' + options.currencySymbol + MathHelper.getRoundedNumber(this.price) + '</td>' +
          '<td title="Quantity"><input id = "cart-quantity" type="number" min="1" style="width: 35px; text-align: center; margin : 0 7px;" class="' + classProductQuantity + ' text-center" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="text-right ' + classProductTotal + '">' + options.currencySymbol + MathHelper.getRoundedNumber(total) + '</td>' +
          '<td title="Remove from Cart" class="text-center" style="width: 30px; height: 30px; color: #808080;"><a href="javascript:void(0);" class="fa fa-trash ' + classProductRemove + '"></a></td>' +
          '</tr>'
        );
      });
